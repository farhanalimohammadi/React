    ...
    <div className="w-full min-h-screen bg-componentBg-primeryBg flex flex-col justify-start items-center relative overflow-x-hidden">
      ...
      <div className="w-full flex flex-col justify-start items-center gap-y-[120px] mt-[140px] ">
        <div className="flex flex-col justify-center items-center gap-y-8 w-full relative">
                      ...
                      type="search" name="search-faq" id="search-faq" placeholder="Write Here..." className="w-[75.66%] bg-componentBg-inputBg rounded-[12px] pl-10 pr-4 py-3 border-none outline-none text-textsColor-texts text-nameSize font-medium z-10 focus:shadow-[0px_0px_30px_-8px_#1481FE] transition-all duration-300 ease-linear ">
                      </input>
